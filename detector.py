...
mp_line = mp_drawing.DrawingSpec(thickness=1, circle_radius=1, color=(200, 200, 200))
...
while True:
    ...
    if time_elapsed > 1.0 / frame_rate:
        ...
        if faces_found != None:
            for this_face_landmark in faces_found:
                ...
                # print("-----------")
                if cellphone_detection.count(1) >= 5:
                    alert_raised = True
                ...
                average_ear = sum(ear_vector) / len(ear_vector)
                
                if(average_ear < 0.10):
                    last_category = 'Ojos Cerrados'
                else:
                    last_category = 'Ojos abiertos'
                    
                '''if count_rate == 5:
                    if len(ear_vector) > 14:
                        input_vector = ear_vector
                        # predicted_category = predict_category(input_vector)
                        predicted_category = "long_blink"
                ...
                print(f'{time.time()}, {text}, {last_category}, {round(EAR, 2)}, {status_cellphone}, {status_cigarrete}')
    ...
    if detection_result_list:
        ...
        # print('vis')
        vis_image = visualize(frame, detection_result_list[0])
